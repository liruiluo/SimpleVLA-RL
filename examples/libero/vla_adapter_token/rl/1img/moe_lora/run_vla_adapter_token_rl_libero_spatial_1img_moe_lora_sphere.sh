...
# 1-image launcher for LIBERO-Spatial VLA-Adapter token RL using MoE-LoRA + SPHERE.
#
# This wraps:
#   `examples/libero/vla_adapter_token/rl/1img/moe_lora/run_vla_adapter_token_rl_libero_1img_moe_lora_sphere.sh`
#
# Usage:
#   bash examples/libero/vla_adapter_token/rl/1img/moe_lora/run_vla_adapter_token_rl_libero_spatial_1img_moe_lora_sphere.sh
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-libero_spatial_vla_adapter_token_moe_lora_sphere_rl_1img}"
