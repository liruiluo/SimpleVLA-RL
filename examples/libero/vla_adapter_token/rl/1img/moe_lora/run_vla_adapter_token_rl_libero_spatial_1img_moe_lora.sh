...
# 1-image launcher for LIBERO-Spatial VLA-Adapter token RL using MoE-LoRA.
# This wraps `examples/libero/vla_adapter_token/rl/1img/run_vla_adapter_token_rl_libero_1img.sh`.
#
# Usage:
#   bash examples/libero/vla_adapter_token/rl/1img/moe_lora/run_vla_adapter_token_rl_libero_spatial_1img_moe_lora.sh
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-libero_spatial_vla_adapter_token_moe_lora_rl_1img}"
