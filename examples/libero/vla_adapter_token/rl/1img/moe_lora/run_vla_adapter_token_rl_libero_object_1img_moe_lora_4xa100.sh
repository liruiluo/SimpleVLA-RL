...
# Thin wrapper around `examples/libero/vla_adapter_token/rl/1img/moe_lora/run_vla_adapter_token_rl_libero_object_1img_moe_lora.sh`.
#
# Usage:
#   bash examples/libero/vla_adapter_token/rl/1img/moe_lora/run_vla_adapter_token_rl_libero_object_1img_moe_lora_4xa100.sh
