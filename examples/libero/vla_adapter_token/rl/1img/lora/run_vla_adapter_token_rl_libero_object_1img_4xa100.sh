...
# Thin wrapper around `examples/libero/vla_adapter_token/rl/1img/lora/run_vla_adapter_token_rl_libero_object_1img.sh`.
#
# Usage:
#   bash examples/libero/vla_adapter_token/rl/1img/lora/run_vla_adapter_token_rl_libero_object_1img_4xa100.sh
#   # optional: pass extra Hydra overrides at the end
#   bash examples/libero/vla_adapter_token/rl/1img/lora/run_vla_adapter_token_rl_libero_object_1img_4xa100.sh trainer.total_steps=230
